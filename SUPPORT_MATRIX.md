...
All rows remain **unqualified / unsupported**. A preliminary user-reported iPhone 16 capture/patch run exists; the integrated tabletop flow still needs a new physical test. API detection, desktop QA and synthetic replay do not
...
| I3  | iPhone 16/17                                      | current and beta Safari capture, patch | preliminary only | [initial feedback](docs/evidence/2026-09-07-initial-phone-feedback.md) |
