...
All rows remain **unqualified / unsupported**. A preliminary user-reported iPhone 16 capture/patch
run exists; two integrated tabletop recordings show failure. The plane-map tracker needs a new
physical test. API detection, desktop QA and synthetic replay do not
...
| I3  | iPhone 16/17                                      | current and beta Safari capture, patch | preliminary only | [feedback and two failed tabletop runs](docs/evidence/2026-09-07-tabletop-recording-2-review.md) |
