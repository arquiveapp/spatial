...
All rows remain **unqualified / unsupported**. A preliminary user-reported iPhone 16 capture/patch run exists; the first integrated tabletop recording shows failure. The revised tracker needs a new physical test. API detection, desktop QA and synthetic replay do not
...
| I3  | iPhone 16/17                                      | current and beta Safari capture, patch | preliminary only | [feedback and failed tabletop](docs/evidence/2026-09-07-tabletop-video-review.md) |
